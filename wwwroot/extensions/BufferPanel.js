export class TestPanel extends Autodesk.Viewing.UI.DockingPanel {
    constructor(extension, id, title, options) {
        ...
        this.isFilterBySelectedEnabled = false; // Add this line  
    }
    ...
    initialize() {
        ...
        toggleDiv.id = 'toggle_div';
        toggleDiv.textContent = 'Filter by Selected';
        toggleDiv.style.backgroundColor = 'lightgrey';
        ...
        toggleDiv.addEventListener('click', () => {
            ...
            if (toggleDiv.classList.contains('on')) {
                toggleDiv.classList.remove('on');
                toggleDiv.style.backgroundColor = 'lightgrey';
                console.log('Toggle off');
                this.extension.isFilterBySelectedEnabled = false; // Update the property
            } else {
                toggleDiv.classList.add('on');
                toggleDiv.style.backgroundColor = 'darkgrey';
                console.log('Toggle on');
                this.extension.isFilterBySelectedEnabled = true; // Update the property
                // this.table.setFilter(row => filteredTargetNodes.includes(row.getData().dbId)); // Set a filter on the table

            }
        });

        // Append the toggle div to the columnFilterDiv
        this.columnFilterDiv.appendChild(toggleDiv);
