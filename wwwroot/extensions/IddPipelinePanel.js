export class IddPipelinePanel extends Autodesk.Viewing.UI.DockingPanel {
    ...
    createTable() {
        ...
        // Create the Tabulator table and store it as a property of the IddPipelinePanel instance
